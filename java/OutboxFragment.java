...
public class OutboxFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvOut = view.findViewById(R.id.rvOut);
        ...
        if (sharedPreferences.getString("position", "").equals(getString(R.string.renci1))) {
            reference.child("Users").child("Student").child(student_name + " " + student_surname).child("full_name")
                    .child("messages").child("sent").addChildEventListener(new ChildEventListener() {
                        @Override
                        public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                            ...
                            rvOut.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        if (sharedPreferences.getString("position", "").equals(getString(R.string.retmen1))) {
        ...
        if (sharedPreferences.getString("position", "").equals(getString(R.string.personel1))) {
