...
public class Individual4Based4Admin4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_individual4_based4_admin4);
        ...
        staffInterface.showStaffPrint(student_name, student_surname, student_password).enqueue(new Callback<StaffResponse>() {
            ...
            public void onResponse(Call<StaffResponse> call, Response<StaffResponse> response) {
                if (response.isSuccessful()) {
                    arrayList.add(getString(R.string.bir_g_ndeki_yakla_k_ortalama_su_ayak_iziniz2) + response.body().getSuccess() + getString(R.string.litre_g_n3));
                    ...
                    arrayAdapter = new ArrayAdapter<>(Individual4Based4Admin4Activity.this,
            ...
            public void onFailure(Call<StaffResponse> call, Throwable t) {
                Toast.makeText(Individual4Based4Admin4Activity.this, getString(R.string.bilgiler_al_n_rken_bir_hata_olu_tu), Toast.LENGTH_SHORT).show();
            }
        });
    }
