...
public class ApiUtilsTeachers {
    ...
    private static final String FIRST_BASE_URL = "https://0.0.0.0:1121/"; // Replace with your actual server URL
    private static final String SECOND_BASE_URL = "https://0.0.0.0:4338"; // Replace with your actual server URL
